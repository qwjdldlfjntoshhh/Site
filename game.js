...
const animalCollection = [
    "Кошка", "Река", "Собака", "Горы", "Машина", "Тигр", "Слон", "Лев", "Дом", "Медведь", "Автомобиль", "Лошадь", "Трава", "Пингвин", "Крокодил", "Рыба", "Велосипед", "Змея", "Пальма", "Волк", "Котёнок", "Утка", "Курица", "Орел", "Рак"
];
...
function renderLevelTwoGame() {
    ...
    const wordCollections = [
        ["пень", "лес", "дом", "кошка", "река", "гора", "дерево", "забор", "собака", "птица"],
        ["цветок", "медведь", "луна", "горы", "озеро", "звезда", "лошадь", "солнце", "дуб", "пруд"],
...
function renderLevelThreeGame() {
    ...
    // Коллекции слов
    const correctWords = [
        "кошка", "собака", "лошадь", "слон", "тигр", "пингвин", "утка", "змея", "волк", "медведь"
    ];
    const incorrectWords = [
        "рек", "гор", "до", "дерев", "звезд", "машин", "автомобил", "велосипе", "лун", "пру"
    ];
